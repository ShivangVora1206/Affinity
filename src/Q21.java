...
/**
 * Servlet implementation class Q21
 */
public class Q21 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ21(answer);
		System.out.println("q21"+Creds.getQ21());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set agr1=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q21 added");
			response.sendRedirect("Q22.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
