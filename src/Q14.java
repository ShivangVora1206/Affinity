...
/**
 * Servlet implementation class Q14
 */
public class Q14 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ14(answer);
		System.out.println("q14"+Creds.getQ14());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set est4=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q14 added");
			response.sendRedirect("Q15.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
