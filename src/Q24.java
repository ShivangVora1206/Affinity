...
/**
 * Servlet implementation class Q24
 */
public class Q24 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ24(answer);
		System.out.println("q24"+Creds.getQ24());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set agr4=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q24 added");
			response.sendRedirect("Q25.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
