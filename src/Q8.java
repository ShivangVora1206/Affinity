...
/**
 * Servlet implementation class Q8
 */
public class Q8 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ8(answer);
		System.out.println("q8"+Creds.getQ8());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set ext8=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q8 added");
			response.sendRedirect("Q9.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
