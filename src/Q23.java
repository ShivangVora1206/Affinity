...
/**
 * Servlet implementation class Q23
 */
public class Q23 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ23(answer);
		System.out.println("q23"+Creds.getQ23());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set agr3=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q23 added");
			response.sendRedirect("Q24.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
