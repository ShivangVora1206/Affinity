...
/**
 * Servlet implementation class Q25
 */
public class Q25 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ25(answer);
		System.out.println("q25"+Creds.getQ25());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set agr5=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q25 added");
			response.sendRedirect("Q26.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
