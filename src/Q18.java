...
/**
 * Servlet implementation class Q18
 */
public class Q18 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ18(answer);
		System.out.println("q18"+Creds.getQ18());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set est8=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q18 added");
			response.sendRedirect("Q19.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
