...
/**
 * Servlet implementation class Q30
 */
public class Q30 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ30(answer);
		System.out.println("q30"+Creds.getQ30());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set agr10=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q30 added");
			response.sendRedirect("Q31.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
