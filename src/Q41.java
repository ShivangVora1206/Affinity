...
/**
 * Servlet implementation class Q41
 */
public class Q41 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ41(answer);
		System.out.println("q41"+Creds.getQ41());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set opn1=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q41 added");
			response.sendRedirect("Q42.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
