...
/**
 * Servlet implementation class Q9
 */
public class Q9 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ9(answer);
		System.out.println("q9"+Creds.getQ9());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set ext9=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q9 added");
			response.sendRedirect("Q10.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
