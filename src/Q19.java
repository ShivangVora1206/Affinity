...
public class Q19 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ19(answer);
		System.out.println("q19"+Creds.getQ19());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set est9=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q19 added");
			response.sendRedirect("Q20.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
