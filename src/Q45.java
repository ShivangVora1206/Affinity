...
/**
 * Servlet implementation class Q45
 */
public class Q45 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ45(answer);
		System.out.println("q45"+Creds.getQ45());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set opn5=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q45 added");
			response.sendRedirect("Q46.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
