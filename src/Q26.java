...
/**
 * Servlet implementation class Q26
 */
public class Q26 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ26(answer);
		System.out.println("q26"+Creds.getQ26());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set agr6=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q26 added");
			response.sendRedirect("Q27.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
