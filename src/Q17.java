...
/**
 * Servlet implementation class Q17
 */
public class Q17 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ17(answer);
		System.out.println("q17"+Creds.getQ17());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set est7=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q17 added");
			response.sendRedirect("Q18.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
