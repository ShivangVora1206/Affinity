...
public class Q16 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ16(answer);
		System.out.println("q16"+Creds.getQ16());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set est6=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q16 added");
			response.sendRedirect("Q17.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
