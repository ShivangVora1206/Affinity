...
/**
 * Servlet implementation class Q11
 */
public class Q11 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ11(answer);
		System.out.println("q11"+Creds.getQ11());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set est1=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q11 added");
			response.sendRedirect("Q12.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
