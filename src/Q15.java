...
/**
 * Servlet implementation class Q15
 */
public class Q15 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ15(answer);
		System.out.println("q15"+Creds.getQ15());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set est5=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q15 added");
			response.sendRedirect("Q16.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
