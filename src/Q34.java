...
public class Q34 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ34(answer);
		System.out.println("q34"+Creds.getQ34());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set csn4=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q34 added");
			response.sendRedirect("Q35.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
