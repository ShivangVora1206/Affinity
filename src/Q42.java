...
/**
 * Servlet implementation class Q42
 */
public class Q42 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Creds.setQ42(answer);
		System.out.println("q42"+Creds.getQ42());
		System.out.println(answer);
		Connection con = DBConnector.connect();
		try{
		String query = "update useranswers set opn2=? where email=? and userid=?";
		...
		if(i > 0){
			System.out.println("q42 added");
			response.sendRedirect("Q43.html");
		}
		}catch(Exception e){
			e.printStackTrace();
		}
